...
#SBATCH --output=job-25masking-%j.log   # Save stdout to job-<jobid>.log
#SBATCH --error=job-25masking-%j.err    # Save stderr to job-<jobid>.err
...
python train_mask.py --config="configs/highRes_only/MAE2.yaml"
