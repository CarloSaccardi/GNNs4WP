...
#SBATCH --output=job-5masking-%j.log   # Save stdout to job-<jobid>.log
#SBATCH --error=job-5masking-%j.err    # Save stderr to job-<jobid>.err
...
python train_mask.py --config="configs/highRes_only/MAE1.yaml"
